...
Q_ENUM_NS(Scope)
QML_NAMED_ELEMENT(SekViewModelType)
}

namespace SekNetworkType {
Q_NAMESPACE
enum CacheMode {
    NoCache = 0x0000,
...
Q_ENUM_NS(CacheMode)
QML_NAMED_ELEMENT(SekNetworkType)
}

namespace SekThemeType {
Q_NAMESPACE
enum DarkMode {
    System = 0x0000,
    Light = 0x0001,
...
Q_ENUM_NS(DarkMode)
QML_NAMED_ELEMENT(SekThemeType)
}

namespace SekTimelineType {
Q_NAMESPACE
enum Mode {
    Left = 0x0000,
    Right = 0x0001,
...
QML_NAMED_ELEMENT(SekTimelineType)
}

namespace SekPageType {
Q_NAMESPACE
enum LaunchMode {
    Standard = 0x0000,
    SingleTask = 0x0001,
...
QML_NAMED_ELEMENT(SekPageType)
}

namespace SekWindowType {
Q_NAMESPACE
enum LaunchMode {
    Standard = 0x0000,
    SingleTask = 0x0001,
...
Q_ENUM_NS(LaunchMode)
QML_NAMED_ELEMENT(SekWindowType)
}

namespace SekTreeViewType {
Q_NAMESPACE
enum SelectionMode {
    None = 0x0000,
    Single = 0x0001,
...
QML_NAMED_ELEMENT(SekTreeViewType)
}

namespace SekStatusLayoutType {
Q_NAMESPACE
enum StatusMode {
    Loading = 0x0000,
    Empty = 0x0001,
...
QML_NAMED_ELEMENT(SekStatusLayoutType)
}

namespace SekContentDialogType {
Q_NAMESPACE
enum ButtonFlag {
...
QML_NAMED_ELEMENT(SekContentDialogType)
}

namespace SekTimePickerType {
Q_NAMESPACE
enum HourFormat {
    H = 0x0000,
    HH = 0x0001
...
QML_NAMED_ELEMENT(SekTimePickerType)
}

namespace SekCalendarViewType {
Q_NAMESPACE
enum DisplayMode {
    Month = 0x0000,
    Year = 0x0001,
...
QML_NAMED_ELEMENT(SekCalendarViewType)
}

namespace SekTabViewType {
Q_NAMESPACE
...
QML_NAMED_ELEMENT(SekTabViewType)
}

namespace SekNavigationViewType {
Q_NAMESPACE
enum DisplayMode {
    Open = 0x0000,
    Compact = 0x0001,
...
Q_ENUM_NS(PageMode)
QML_NAMED_ELEMENT(SekNavigationViewType)
}

namespace Sekent_Awesome {
Q_NAMESPACE
enum class Sekent_AwesomeType {
...
Q_ENUM_NS(Sekent_AwesomeType)
QML_NAMED_ELEMENT(SekentIcons)
}
