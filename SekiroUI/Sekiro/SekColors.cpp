...
SekColors::SekColors(QObject *parent):QObject{parent}{
    ...
    SekColorSet *yellow = new SekColorSet(this);
    ...
    SekColorSet *orange = new SekColorSet(this);
    ...
    SekColorSet *red = new SekColorSet(this);
    red->darkest("#8f0a15");
    red->darker("#a20b18");
    red->dark("#b90d1c");
    red->normal("#e81123");
    ...
    SekColorSet *magenta = new SekColorSet(this);
    ...
    SekColorSet *purple = new SekColorSet(this);
    ...
    SekColorSet *blue = new SekColorSet(this);
    blue->darkest("#004A83");
    blue->darker("#005494");
    blue->dark("#0066B4");
    blue->normal("#0078D4");
    ...
    SekColorSet *teal = new SekColorSet(this);
    teal->darkest("#006E5B");
    teal->darker("#007C67");
    teal->dark("#00977D");
    teal->normal("#00B294");
    ...
    SekColorSet *green = new SekColorSet(this);
