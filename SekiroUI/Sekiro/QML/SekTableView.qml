...
Rectangle {
    ...
    property color borderColor: SekTheme.dark ? "#252525" : "#e4e4e4"
    property alias tableModel: table_model
    property alias tableView: table_view
    property bool horizonalHeaderVisible: true
    property bool verticalHeaderVisible: true
    id:control
    color: SekTheme.dark ? Qt.rgba(39/255,39/255,39/255,1) : Qt.rgba(251/255,251/255,253/255,1)
    ...
    Component{
        ...
        Item{
            ...
            SekIconButton{
                iconSource:SekentIcons.ChromeClose
                iconSize: 10
                width: 20
                height: 20
                visible: {
    ...
    MouseArea{
        ...
        ScrollView{
            ...
            TableView {
                ...
                ScrollBar.horizontal: SekScrollBar{
                    id:scroll_bar_h
                }
                ScrollBar.vertical: SekScrollBar{
                    id:scroll_bar_v
                    ...
                    Rectangle{
                        ...
                        color:{
                            if(d.rowHoverIndex === row || item_table.isRowSelected){
                                return SekTheme.dark ? Qt.rgba(1,1,1,0.06) : Qt.rgba(0,0,0,0.06)
                            }
                            return (row%2!==0) ? control.color : (SekTheme.dark ? Qt.rgba(1,1,1,0.015) : Qt.rgba(0,0,0,0.015))
                        }
                        Rectangle{
                            height: 18
                            radius: 1.5
    ...
    TableView {
        ...
        delegate: Rectangle {
            ...
            color: SekTheme.dark ? Qt.rgba(50/255,50/255,50/255,1) : Qt.rgba(247/255,247/255,247/255,1)
            Rectangle{
            ...
            MouseArea{
                ...
                onPressed :
                    (mouse)=>{
                        ...
                        SekTools.setOverrideCursor(Qt.SplitHCursor)
                        clickPos = Qt.point(mouse.x, mouse.y)
                    }
                onReleased:{
                    header_horizontal.interactive = true
                    SekTools.restoreOverrideCursor()
                }
                onCanceled: {
                    header_horizontal.interactive = true
                    SekTools.restoreOverrideCursor()
            ...
            MouseArea{
                ...
                onPressed :
                    (mouse)=>{
                        ...
                        SekTools.setOverrideCursor(Qt.SplitVCursor)
                        clickPos = Qt.point(mouse.x, mouse.y)
                    }
                onReleased:{
