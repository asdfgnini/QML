...
Item {
    ...
    property color lineColor: SekTheme.dark ? Qt.rgba(111/255,111/255,111/255,1) : Qt.rgba(217/255,217/255,217/255,1)
    id:control
    QtObject {
        id:d
        property int dy
        ...
        property color hitColor: SekTheme.primaryColor
    }
    onDataSourceChanged: {
        ...
        Item{
            ...
            Rectangle{
                ...
                Rectangle{
                    ...
                    color: SekTheme.dark ? SekColors.Black : SekColors.White
                    anchors{
                        top: parent.top
                        left: parent.left
                        topMargin: -3
            ...
            Rectangle{
                ...
                color: {
                    ...
                    if(item_mouse.containsMouse || item_check_box.hovered){
                        return SekTheme.itemHoverColor
                    }
            ...
            SekText {
                ...
                color:{
                    if(itemMouse.pressed){
                        return SekTheme.dark ? SekColors.Grey80 : SekColors.Grey120
                    }
                    return SekTheme.dark ? SekColors.White : SekColors.Grey220
                }
            }
        }
    }
