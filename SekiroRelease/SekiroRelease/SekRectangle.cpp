...
SekRectangle::SekRectangle(QQuickItem* parent) : QQuickPaintedItem(parent){
    color(QColor(255,255,255,255));
    radius({0,0,0,0});
    connect(this,&SekRectangle::colorChanged,this,[=]{update();});
    connect(this,&SekRectangle::radiusChanged,this,[=]{update();});
}

void SekRectangle::paint(QPainter* painter){
    painter->save();
